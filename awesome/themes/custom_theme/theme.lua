...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/custom_theme/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/custom_theme/wall.png"
theme.font                                      = "Roboto Bold 10"
theme.taglist_font                              = "Roboto Condensed Regular 8"
theme.fg_normal                                 = "#F5E9E2"
...
theme.widget_temp                               = theme.icon_dir .. "/icons/temp.png"
...
-- My Widgets
local cpu_icon = wibox.widget.imagebox(theme.cpu)
local ip = lain.widget.ip({
    settings = function()
        widget:set_markup(space3 .. markup.font(theme.font, ip_now) .. markup.font("Roboto 5", " "))
    end
})
local ipbg = wibox.container.background(ip.widget, theme.bg_focus, gears.shape.rectangle)
local ip_widget = wibox.container.margin(ipbg, dpi(0), dpi(0), dpi(5), dpi(5))
